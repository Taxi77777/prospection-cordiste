...
# Filet de securite : prefixes de code NAF/APE grand public a exclure malgre l'inclusion de leur
# section (ex. la restauration est dans la meme section que l'hebergement/hotels qu'on veut garder).
EXCLURE_PREFIXES = (
